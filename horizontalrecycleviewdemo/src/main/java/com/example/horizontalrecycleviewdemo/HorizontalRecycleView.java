...
public class HorizontalRecycleView extends RecyclerView {
    private static final String TAG = HorizontalRecycleView.class.getSimpleName();
    ...
    public HorizontalRecycleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void rightScrollBy(int position, int lastVisiblePosition) {
        ...
        if (rightChild != null) {
            ...
            int startRight = dx;
            int endRight = position == lastVisiblePosition ? -1 * rightChild.getWidth() : 0;
    ...
    public void smoothToCenter(int position) {
        ...
        Log.i(TAG, "firstPosition:" + firstVisiblePosition + "   lastPosition:" + lastVisiblePosition + "   position:" + position +
