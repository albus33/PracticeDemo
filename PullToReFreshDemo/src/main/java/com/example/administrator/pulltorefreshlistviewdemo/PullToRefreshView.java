...
public class PullToRefreshView extends LinearLayout {
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.libs_listview_header, this,
                false);

        mHeaderImageView = (ImageView) mHeaderView
                .findViewById(R.id.libs_listview_header_arrow);
        mHeaderTextView = (TextView) mHeaderView
                .findViewById(R.id.libs_listview_header_hint_textview);
        mHeaderUpdateTextView = (TextView) mHeaderView
                .findViewById(R.id.libs_listview_header_time);
        mHeaderProgressBar = (ProgressBar) mHeaderView
                .findViewById(R.id.libs_listview_header_progressbar);
        // header layout
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.libs_listview_footer, this,
                false);
        // mFooterImageView = (ImageView) mFooterView
        // .findViewById(R.id.pull_to_load_image);
        mFooterTextView = (TextView) mFooterView
                .findViewById(R.id.libs_listview_footer_hint_textview);
        mFooterProgressBar = (ProgressBar) mFooterView
                .findViewById(R.id.libs_listview_footer_progressbar);
        // footer layout
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
            mHeaderTextView.setText(R.string.libs_listview_header_hint_ready);
            ...
            mHeaderImageView.startAnimation(mFlipAnimation);
            // mHeaderImageView.
            mHeaderTextView.setText(R.string.libs_listview_header_hint_normal);
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)*2
            ...
            mFooterTextView.setText(R.string.pull_to_refresh_footer_hint_ready);//松开载入更多
            ...
            // mFooterImageView.clearAnimation();
            // mFooterImageView.startAnimation(mFlipAnimation);
            mFooterTextView.setText(R.string.pull_to_refresh_header_hint_normal2);
            ...
            if(Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)){
                mFooterTextView.setText(R.string.pull_to_refresh_header_hint_normal2);
                mFooterState = PULL_TO_REFRESH;
            //小于mHeaderViewHeight + mFooterViewHeight的值时，保留“没有更多”字体。暂时修改 by:XY
            }else if(Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)){
               // mFooterTextView.setText(R.string.pull_to_refresh_header_hint_normal2);
            }
        }
    ...
    private void footerRefreshing() {
        ...
        mFooterTextView.setText(R.string.libs_listview_header_hint_loading);
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.mipmap.libs_listview_arrow);
        mHeaderTextView.setText(R.string.libs_listview_header_hint_normal);
        mHeaderProgressBar.setVisibility(View.GONE);
        mHeaderState = PULL_TO_REFRESH;
        setLastUpdated("最近更新:" + DateFormat.getDateString(curTime));
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterTextView.setText(R.string.pull_to_refresh_header_hint_normal3);
