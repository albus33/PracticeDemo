...
import tv.danmaku.ijk.media.player.exo.demo.EventLogger;
import tv.danmaku.ijk.media.player.exo.demo.player.DemoPlayer;
import tv.danmaku.ijk.media.player.exo.demo.player.DemoPlayer.RendererBuilder;
import tv.danmaku.ijk.media.player.exo.demo.player.ExtractorRendererBuilder;
import tv.danmaku.ijk.media.player.exo.demo.player.HlsRendererBuilder;
import tv.danmaku.ijk.media.player.exo.demo.player.SmoothStreamingRendererBuilder;
import tv.danmaku.ijk.media.player.exo.demo.SmoothStreamingTestMediaDrmCallback;
